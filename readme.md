...
```
智能体/
├── 01_simple_agent_demo/        # 智能体基础概念与简单实现
├── 02_llm_agent._demo/          # LLM智能体工程化实现
├── 03_llm_agent_long_memory/    # 长期记忆系统
├── 04_tools/                    # 多工具扩展
├── 05_llm_search/               # 联网搜索能力
├── 06_multi_step/               # 任务规划与多步骤执行
├── 07_agent_structured_memory/  # 结构化长期记忆
├── 08_agent_knowledge_system/   # 外部知识库接入
├── 09_workflow/                 # 智能体工作流引擎
├── 10_MultiAgent/               # 多智能体系统
├── 11_skills/                   # 智能体Skill体系
├── 12_SKILL.md/                 # Skill工程化落地
├── 13_MCP/                      # Model Control Protocol
├── 14_mcp_net/                  # MCP网关与多技能调度
├── 15_mcp_safe/                 # MCP安全与审计
├── 16_UI/                       # 智能体UI设计
├── 17_multiAgent2/              # 多智能体协作
├── 18_next_tech/                # 前沿技术展望
├── agent_memory.json            # 智能体记忆文件
├── llm_agent_long_memory.json   # LLM智能体长期记忆
└── readme.md                    # 项目文档
```
